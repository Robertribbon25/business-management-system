...
import { Building2, Lock, Mail, RefreshCw, Key, ShieldCheck } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 font-sans antialiased text-slate-100 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-white drop-shadow-md">DAB Enterprise Ltd</h1>
          <p className="mt-2 text-xs font-bold tracking-widest text-[#a5b4fc] uppercase">Business Management System</p>
        </div>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="bg-white/5 backdrop-blur-xl py-8 px-6 border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.37)] rounded-2xl space-y-6 sm:px-10">
          ...
          <h2 className="text-lg font-bold text-white tracking-wide leading-tight border-b border-white/5 pb-2">Corporate Sign-In</h2>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-2.5 border border-white/10 rounded-xl text-sm font-medium bg-white/5 text-white placeholder-slate-450 focus:outline-none focus:border-blue-500 focus:bg-white/10 focus:ring-1 focus:ring-blue-500 transition"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center items-center py-2.5 px-4 bg-gradient-to-r from-blue-650 to-blue-550 hover:from-blue-600 hover:to-blue-500 text-white font-bold text-sm tracking-wide rounded-xl shadow-[0_4px_20px_rgba(37,99,235,0.25)] hover:shadow-[0_4px_24px_rgba(37,99,235,0.4)] transition cursor-pointer disabled:opacity-50"
            >
              {loading ? (
          ...
          {/* Quick review logging credentials helper */}
          <div className="pt-6 border-t border-white/5">
            ...
            <div className="grid grid-cols-2 gap-2.5">
              <button
                type="button"
                onClick={() => handleQuickLogin('admin@dab.com', 'admin123')}
              ...
              >
                ...
                <p className="text-xs font-mono font-bold mt-1 text-white">admin@dab.com</p>
                <p className="text-[10px] text-slate-400 font-medium group-hover:text-slate-300">pass: admin123</p>
              </button>

              <button
                type="button"
                onClick={() => handleQuickLogin('manager@dab.com', 'manager123')}
              ...
              >
                ...
                <p className="text-xs font-mono font-bold mt-1 text-white">manager@dab.com</p>
                <p className="text-[10px] text-slate-400 font-medium group-hover:text-slate-300">pass: manager123</p>
              </button>
            </div>
          </div>
